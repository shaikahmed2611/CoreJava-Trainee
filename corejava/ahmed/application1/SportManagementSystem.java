	...
	public static void main(String[] args) {
		...
		while(true)
		{
		    ...
		    case O:
		    	...
		    	System.out.println("");
		    	System.out.println("3 \t AUSTRALIA T-SHIRT\t    RM700.00 per unit ");
		    	System.out.println("");
		    	System.out.println("4 \t ENGLAND T-SHIRT\t   RM700.00 per unit ");
		    ...
		    case CE:
		    	...
		    	System.out.println("Your Equipment Cost RM"+equipmentcost);
		    	break;
		    ...
		    case R:
				...
				System.out.println("you selected no of guests are RM"+guestcost);
				System.out.println("you selected equipment cost RM"+equipmentcost);
				...
				System.out.println("======================");
				System.out.println("you selected  ticket cost Rs"+amountcost);
				System.out.println("you selected no of guests are "+guestcost);
				System.out.println("Amount for  after Discount for selected Ticket is  Rs"+amountdisc);
